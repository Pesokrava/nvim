-- Build neotest dependencies and adapters based on available runtimes.
...
local has_python = has("python3") == 1
local has_go = has("go") == 1
local has_rust = has("cargo") == 1
...
if has_rust then
  table.insert(deps, "mrcjkb/rustaceanvim")
end
